...
let submitBtn = document.getElementById('submitAnswer').addEventListener('click', farm);

function farm() {
    if (userrAnswer.value == "Cow") {
        document.getElementById('submitAnswer').innerHTML = "E-I-E-I-O!";
        document.getElementById('submitAnswer').style.color = "Red";  
    }
...
let hereMooBtn = document.getElementById('hereBtn').addEventListener('click', mooText);
let thereMooBtn = document.getElementById('thereBtn').addEventListener('click', mooText2);
let everywhereMooBtn = document.getElementById('everywhereMoo').addEventListener('click', mooSound);
let mooNoise = document.getElementById('cowMoo');

function mooText() {
   document.getElementById('hereBtn').innerHTML = "" 
   document.getElementById('hereBtn').style.backgroundImage = "url(cow_image2.jpg)";
...
function mooText2() {
    ...
    document.getElementById('thereBtn').style.backgroundImage = "linear-gradient(to left, orange , yellow, green, cyan, blue, violet)";
...
function finalMcdonald() {
    ...
    document.getElementById('lastWord').style.color = "red";
